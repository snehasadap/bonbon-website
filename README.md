# bonbon-website
Followed JavaScript Mastery's [tutorial](https://youtu.be/QRrPE9aj3wI?si=4ju1ys6aX1PXp2oq) on YT for layout and animations, and added my personal touch - desserts! You can view the site deployed on your desktop [here](https://bonbon-desserts.net/). Made with pure HTML/CSS and a little bit of JavaScript for the animations.
## Getting Started
